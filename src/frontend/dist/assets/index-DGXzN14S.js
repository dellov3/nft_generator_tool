const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Workshop-Dqm_0efJ.js","assets/card-D49-wyLU.js","assets/scroll-area-Ctm_hUul.js","assets/select-DeYUWm7_.js","assets/index-En5dbdiO.js","assets/chevron-down-5t-Rjt0z.js","assets/slider-B54R2EoQ.js","assets/RarityWorkshop-DuPUrZ2V.js","assets/lock-Cy0h3-oN.js","assets/Rules-Cr5efITY.js","assets/Vault-B2YNrkvY.js","assets/pinata-0w7eDYwC.js","assets/Settings-BWwJGcjF.js"])))=>i.map(i=>d[i]);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-1 flex-1", children: navItems.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              className: `motion-button motion-press-snappy relative text-sm font-medium px-3 h-9 rounded-lg overflow-hidden transition-[color,background-color,border-color] duration-hover ease-apple ${isActive ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`,
              children: item.label
            },
            item.id
          );
...
function CreateProjectDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "bg-card border border-border max-w-xl rounded-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 py-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-muted/30 border border-border rounded-xl transition-[background-color] duration-hover ease-apple hover:bg-muted/40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Label,
          {
            htmlFor: "pixel",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-16 sm:mb-20 fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tighter mb-4 hero-liquid-gradient relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(NewProjectTile, { onClick: () => setIsCreateOpen(true) }),
        projects.map((project, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ProjectTile,
          {
            project,
            animationDelay: Math.min((index2 + 1) * 60, 360),
...
const Workshop = reactExports.lazy(() => __vitePreload(() => import("./Workshop-Dqm_0efJ.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
const RarityWorkshop = reactExports.lazy(() => __vitePreload(() => import("./RarityWorkshop-DuPUrZ2V.js"), true ? __vite__mapDeps([7,1,2,6,4,8]) : void 0));
const Rules = reactExports.lazy(() => __vitePreload(() => import("./Rules-Cr5efITY.js"), true ? __vite__mapDeps([9,2]) : void 0));
const Preview = reactExports.lazy(() => __vitePreload(() => import("./Preview-DXf4h1gD.js"), true ? [] : void 0));
const Builder = reactExports.lazy(() => __vitePreload(() => import("./Builder-CrOHyfHa.js"), true ? [] : void 0));
const Vault = reactExports.lazy(() => __vitePreload(() => import("./Vault-B2YNrkvY.js"), true ? __vite__mapDeps([10,11,8,4,2,5,1]) : void 0));
const Settings = reactExports.lazy(() => __vitePreload(() => import("./Settings-BWwJGcjF.js"), true ? __vite__mapDeps([12,11,2,3,4,5]) : void 0));
